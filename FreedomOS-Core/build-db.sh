...
repo-add -n -R FreedomOS-Core-Repo.db.tar.gz *.pkg.tar.zst

# Removing the symlinks because GitLab can't handle them.
rm FreedomOS-Core-Repo.db
#rm FreedomOS-Core-Repo.db.sig
rm FreedomOS-Core-Repo.files
#rm FreedomOS-Core-Repo.files.sig

# Renaming the tar.gz files without the extension.
mv FreedomOS-Core-Repo.db.tar.gz FreedomOS-Core-Repo.db
#mv FreedomOS-Core-Repo.db.tar.gz.sig FreedomOS-Core-Repo-db.sig
mv FreedomOS-Core-Repo.files.tar.gz FreedomOS-Core-Repo.files
